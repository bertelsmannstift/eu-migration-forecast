...
DROP TABLE IF EXISTS trend.l_language CASCADE;
DROP TABLE IF EXISTS trend.l_keyword CASCADE;
DROP TABLE IF EXISTS trend.l_version CASCADE;
DROP TABLE IF EXISTS trend.l_country CASCADE;
DROP TABLE IF EXISTS trend.a_country_language CASCADE;
DROP TABLE IF EXISTS trend.d_searchword CASCADE;
DROP TABLE IF EXISTS trend.d_trends CASCADE;
