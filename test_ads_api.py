...
def main(client, customer_id, keyword_plan_id):
    ...
    try:
        ...
        print(
            "Request with ID {} failed with status %s and includes the following errors:".format(
    ...
    for i, forecast in enumerate(response.keyword_forecasts):
        print(
            "#{} Keyword ID: {}".format(i + 1, forecast.keyword_plan_ad_group_keyword)
        )
...
if __name__ == "__main__":
    ...
    credentials = {
        "developer_token": "sJ-I6sq-wnhE-4V2plWbYg",
        "client_id": "833597030578-ui2snokjro0ogpj6kdo7q7ec3gasdfc3.apps.googleusercontent.com",
        "client_secret": "JnNGEU4DW20JxkvcOXUqQRH6",
        "refresh_token": "1//09TiNBkhHxY2cCgYIARAAGAkSNgF-L9IrMM5CQR0OsmPXLsrcJ2BE79B1IhMChunPQj5drRqCg3hO_ma_-j3ioOiV4itrbLqufw",
    }
    ...
    # )
    # parser.add_argument(
    #     "-k", "--keyword_plan_id", type=str, required=True, help="A Keyword Plan ID."
    # )
    # args = parser.parse_args()

    # main(google_ads_client, args.customer_id, args.keyword_plan_id)
#    main(google_ads_client, "1884822246", "0")
    main(google_ads_client, "1935421003", 0)
